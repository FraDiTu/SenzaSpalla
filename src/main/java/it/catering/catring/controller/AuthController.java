...
public class AuthController {
    ...
    private void initializeDefaultUsers() {
        ...
        User chef1 = UserFactory.createUser("chef", "chef1", "password", "Francesco", "Di Tullio", "chef@catering.it", "Cucina Italiana");
        User cuoco1 = UserFactory.createUser("cuoco", "cuoco1", "password", "Claudia", "La Rocca", "cuoco@catering.it", "5");
        User organizzatore1 = UserFactory.createUser("organizzatore", "org1", "password", "Umberto", "Cinquegrana", "org@catering.it", null);
