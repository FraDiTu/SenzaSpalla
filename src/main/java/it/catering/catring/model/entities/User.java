// File: src/main/java/it/catering/catring/model/entities/User.java
...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = Cuoco.class, name = "cuoco"),
    @JsonSubTypes.Type(value = Organizzatore.class, name = "organizzatore")
})
