...
public class JsonPersistenceManager {
    ...
    // Metodi specifici per entità esistenti
    ...
    // Nuovi metodi per le nuove entità
    public void saveTurniPreparatori(List<TurnoPreparatorio> turni) {
        saveList(turni, "turni_preparatori.json", TurnoPreparatorio.class);
    }
    
    public List<TurnoPreparatorio> loadTurniPreparatori() {
        return loadList("turni_preparatori.json", TurnoPreparatorio.class);
    }
    
    public void saveTurniServizio(List<TurnoServizio> turni) {
        saveList(turni, "turni_servizio.json", TurnoServizio.class);
    }
    
    public List<TurnoServizio> loadTurniServizio() {
        return loadList("turni_servizio.json", TurnoServizio.class);
    }
    
    public void saveEventi(List<Evento> eventi) {
        saveList(eventi, "eventi.json", Evento.class);
    }
    
    public List<Evento> loadEventi() {
        return loadList("eventi.json", Evento.class);
    }
    
    public void saveClienti(List<Cliente> clienti) {
        saveList(clienti, "clienti.json", Cliente.class);
    }
    
    public List<Cliente> loadClienti() {
        return loadList("clienti.json", Cliente.class);
    }
}