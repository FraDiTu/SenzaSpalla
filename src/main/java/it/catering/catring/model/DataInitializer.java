...
public class DataInitializer {
    ...
    public static void initializeData() {
        ...
        if (!ricettarioManager.getRicettePubblicate().isEmpty()) {
    ...
    private static void createSampleRecipes(RicettarioManager ricettarioManager, User chef, User cuoco) {
        ...
        try {
            ...
            System.err.println("Errore nella pubblicazione ricetta: " + e.getMessage());
        }
        ...
        try {
            ...
            System.err.println("Errore nella pubblicazione preparazione: " + e.getMessage());
        }
    }
    ...
    private static void createSampleMenus(MenuManager menuManager, RicettarioManager ricettarioManager, Chef chef) {
        try {
            ...
            Ricetta tiramisu = ricettePubblicate.stream()
            ...
            menuManager.updateMenu(menuFingerFood);
            
        } catch (Exception e) {
            System.err.println("Errore nella creazione dei menu: " + e.getMessage());
        }
    }
    ...
    private static void createSampleTasks(CompitoManager compitoManager, RicettarioManager ricettarioManager, Cuoco cuoco) {
        try {
            ...
            if (pastaPomodoro != null) {
                ...
                compitoManager.updateCompito(compitoProblema);
            }
            
        } catch (Exception e) {
            System.err.println("Errore nella creazione dei compiti: " + e.getMessage());
        }
    }
}