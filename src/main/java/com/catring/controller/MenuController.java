 ...
 * Controller aggiornato per la gestione completa dei menu con ricette complete
 */
...
public void handleSelezionaMenu() {
    if (menuSelezionato != null) {
        ...
        // AGGIUNTO: Mostra le note se presenti
    ...
    /**
 * NUOVO METODO: Rimuove una sezione dal menu selezionato
 */
...
/**
 * NUOVO METODO: Sposta ricetta con sezioni specificate
 */
public void handleSpostaRicettaConSezioni(String sezioneOrigine, String sezioneDestinazione) {
    if (menuSelezionato == null) {
        mostraErrore("Nessun menu selezionato", "Seleziona un menu");
        return;
    }
    ...
    VoceMenu voceSelezionata = listaVoci.getSelectionModel().getSelectedItem();
