...
/**
 * VISTA UNIFICATA PER LA GESTIONE COMPLETA DEI MENU - VERSIONE CORRETTA FINALE
 */
public class MenuView {
    ...
    private VBox creaPannelloGestioneContenuto() {
        ...
        pannello.setPrefWidth(500); // Più largo per contenere le 3 combo box
        pannello.setStyle("-fx-background-color: #ecf0f1; -fx-padding: 15px; -fx-border-radius: 8px;");
    ...
    private VBox creaSezioneGestioneRicette() {
        ...
        comboSezioniOrigine.setPrefWidth(150);
        ...
        comboRicetteDaSpostare.setPrefWidth(200);
        ...
        comboSezioniDestinazione.setPrefWidth(130);
