 ...
 * Gestisce creazione, modifica, finalizzazione e condivisione menu
 */
public class MenuView {
    ...
    private VBox creaPannelloListaMenu() {
        ...
        tabellaMenu.getColumns().addAll(colonnaNome, colonnaDescrizione);
    ...
    private VBox creaSezioneGestioneSezioni() {
        ...
        Label label = new Label("Aggiungi Sezioni:");
        ...
        pannelloSezione.getChildren().addAll(campoTitoloSezione, bottoneAggiungiSezione);
    ...
    /**
     * Crea la sezione per gestire le ricette
     */
    private VBox creaSezioneGestioneRicette() {
        ...
        comboSezioni.setPromptText("Seleziona sezione");
        comboSezioni.setPrefWidth(300);
        
        comboRicette = new ComboBox<>();
        comboRicette.setPromptText("Seleziona ricetta");
        comboRicette.setPrefWidth(300);
        ...
        pannelloPulsanti.getChildren().addAll(bottoneAggiungiRicetta, bottoneEliminaRicetta, bottoneSpostaRicetta);
        
        sezione.getChildren().addAll(label, comboSezioni, comboRicette, pannelloPulsanti);
        return sezione;
    }
    ...
    private void collegaController() {
        ...
        bottoneSpostaRicetta.setOnAction(e -> controller.handleSpostaRicetta());
