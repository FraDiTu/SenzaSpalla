...
class MenuValidatorTest {
    ...
    void testValidazioneEmail() {
        // Test Information Expert per email - CORREZIONE
        ...
        // CORREZIONE: Questo test falliva perché "test." è considerato valido dal nostro validator semplice
        assertFalse(validator.isValidEmail("test.")); // Email senza dominio dopo il punto
    }
